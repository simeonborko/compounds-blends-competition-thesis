"""Nahradit stlpce z NU a SW za joined stlpce (s prefixom J_) a tiez pridat stlpce lexsh a split point"""
...
NEW = """CREATE OR REPLACE VIEW `nu_full` AS
  select
    ...
    `I`.`im_sub_sem_cat` AS `im_sub_sem_cat`,
    `I`.`im_dom_sem_cat` AS `im_dom_sem_cat`,
    `I`.`im_shape_nonshape` AS `im_shape_nonshape`,
    `I`.`im_sub_name` AS `im_sub_name`,
    `I`.`im_dom_name` AS `im_dom_name`,
    `I`.`im_sub_number` AS `im_sub_number`,
    `I`.`im_dom_number` AS `im_dom_number`,
    `I`.`im_half_number` AS `im_half_number`,
    `I`.`im_dom_half` AS `im_dom_half`,
    `I`.`im_dom_half_number` AS `im_dom_half_number`,
    ...
    `NU`.`J_nu_syllabic` AS `nu_syllabic`,
    `NU`.`J_nu_graphic_len` AS `nu_graphic_len`,
    `NU`.`J_nu_phonetic_len` AS `nu_phonetic_len`,
    `NU`.`J_nu_syllabic_len` AS `nu_syllabic_len`,
    ...
    `SW1`.`established_derived` AS `sw1_established_derived`,
    `SW2`.`established_derived` AS `sw2_established_derived`,
    `SW3`.`established_derived` AS `sw3_established_derived`,
    `SW4`.`established_derived` AS `sw4_established_derived`,
    `SW1`.`structure` AS `sw1_structure`,
    `SW2`.`structure` AS `sw2_structure`,
    `SW3`.`structure` AS `sw3_structure`,
    `SW4`.`structure` AS `sw4_structure`,
    ...
    `SW1`.`J_sw_graphic_len` AS `sw1_graphic_len`,
    `SW2`.`J_sw_graphic_len` AS `sw2_graphic_len`,
    `SW3`.`J_sw_graphic_len` AS `sw3_graphic_len`,
    `SW4`.`J_sw_graphic_len` AS `sw4_graphic_len`,
    `SW1`.`J_sw_phonetic` AS `sw1_phonetic`,
    `SW2`.`J_sw_phonetic` AS `sw2_phonetic`,
    `SW3`.`J_sw_phonetic` AS `sw3_phonetic`,
    `SW4`.`J_sw_phonetic` AS `sw4_phonetic`,
    `SW1`.`J_sw_phonetic_len` AS `sw1_phonetic_len`,
    `SW2`.`J_sw_phonetic_len` AS `sw2_phonetic_len`,
    `SW3`.`J_sw_phonetic_len` AS `sw3_phonetic_len`,
    `SW4`.`J_sw_phonetic_len` AS `sw4_phonetic_len`,
    `SW1`.`J_sw_syllabic` AS `sw1_syllabic`,
    `SW2`.`J_sw_syllabic` AS `sw2_syllabic`,
    `SW3`.`J_sw_syllabic` AS `sw3_syllabic`,
    `SW4`.`J_sw_syllabic` AS `sw4_syllabic`,
    `SW1`.`J_sw_syllabic_len` AS `sw1_syllabic_len`,
    `SW2`.`J_sw_syllabic_len` AS `sw2_syllabic_len`,
    `SW3`.`J_sw_syllabic_len` AS `sw3_syllabic_len`,
    `SW4`.`J_sw_syllabic_len` AS `sw4_syllabic_len`,
    ...
    `GS`.`J_sw1_splinter` AS `gs_sw1_splinter`,
    `GS`.`J_sw2_splinter` AS `gs_sw2_splinter`,
    `GS`.`J_sw3_splinter` AS `gs_sw3_splinter`,
    `GS`.`J_sw4_splinter` AS `gs_sw4_splinter`,
    `GS`.`J_sw1_splinter_len` AS `gs_sw1_splinter_len`,
    `GS`.`J_sw2_splinter_len` AS `gs_sw2_splinter_len`,
    `GS`.`J_sw3_splinter_len` AS `gs_sw3_splinter_len`,
    `GS`.`J_sw4_splinter_len` AS `gs_sw4_splinter_len`,
    (`GS`.`J_sw1_splinter_len` / `SW1`.`J_sw_graphic_len`) AS `gs_sw1_splinter_len_to_sw_len`,
    (`GS`.`J_sw2_splinter_len` / `SW2`.`J_sw_graphic_len`) AS `gs_sw2_splinter_len_to_sw_len`,
    (`GS`.`J_sw3_splinter_len` / `SW3`.`J_sw_graphic_len`) AS `gs_sw3_splinter_len_to_sw_len`,
    (`GS`.`J_sw4_splinter_len` / `SW4`.`J_sw_graphic_len`) AS `gs_sw4_splinter_len_to_sw_len`,
    (`GS`.`J_sw1_splinter_len` / `NU`.`J_nu_graphic_len`) AS `gs_sw1_splinter_len_to_nu_len`,
    (`GS`.`J_sw2_splinter_len` / `NU`.`J_nu_graphic_len`) AS `gs_sw2_splinter_len_to_nu_len`,
    (`GS`.`J_sw3_splinter_len` / `NU`.`J_nu_graphic_len`) AS `gs_sw3_splinter_len_to_nu_len`,
    (`GS`.`J_sw4_splinter_len` / `NU`.`J_nu_graphic_len`) AS `gs_sw4_splinter_len_to_nu_len`,
    `GM`.`type_of_splinter` AS `gm_name`,
    `GM`.`J_sw1_splinter` AS `gm_sw1_splinter`,
    `GM`.`J_sw2_splinter` AS `gm_sw2_splinter`,
    `GM`.`J_sw3_splinter` AS `gm_sw3_splinter`,
    `GM`.`J_sw4_splinter` AS `gm_sw4_splinter`,
    `GM`.`J_sw1_splinter_len` AS `gm_sw1_splinter_len`,
    `GM`.`J_sw2_splinter_len` AS `gm_sw2_splinter_len`,
    `GM`.`J_sw3_splinter_len` AS `gm_sw3_splinter_len`,
    `GM`.`J_sw4_splinter_len` AS `gm_sw4_splinter_len`,
    (`GM`.`J_sw1_splinter_len` / `SW1`.`J_sw_graphic_len`) AS `gm_sw1_splinter_len_to_sw_len`,
    (`GM`.`J_sw2_splinter_len` / `SW2`.`J_sw_graphic_len`) AS `gm_sw2_splinter_len_to_sw_len`,
    (`GM`.`J_sw3_splinter_len` / `SW3`.`J_sw_graphic_len`) AS `gm_sw3_splinter_len_to_sw_len`,
    (`GM`.`J_sw4_splinter_len` / `SW4`.`J_sw_graphic_len`) AS `gm_sw4_splinter_len_to_sw_len`,
    (`GM`.`J_sw1_splinter_len` / `NU`.`J_nu_graphic_len`) AS `gm_sw1_splinter_len_to_nu_len`,
    (`GM`.`J_sw2_splinter_len` / `NU`.`J_nu_graphic_len`) AS `gm_sw2_splinter_len_to_nu_len`,
    (`GM`.`J_sw3_splinter_len` / `NU`.`J_nu_graphic_len`) AS `gm_sw3_splinter_len_to_nu_len`,
    (`GM`.`J_sw4_splinter_len` / `NU`.`J_nu_graphic_len`) AS `gm_sw4_splinter_len_to_nu_len`,
    `PS`.`type_of_splinter` AS `ps_name`,
    `PS`.`J_sw1_splinter` AS `ps_sw1_splinter`,
    `PS`.`J_sw2_splinter` AS `ps_sw2_splinter`,
    `PS`.`J_sw3_splinter` AS `ps_sw3_splinter`,
    `PS`.`J_sw4_splinter` AS `ps_sw4_splinter`,
    `PS`.`J_sw1_splinter_len` AS `ps_sw1_splinter_len`,
    `PS`.`J_sw2_splinter_len` AS `ps_sw2_splinter_len`,
    `PS`.`J_sw3_splinter_len` AS `ps_sw3_splinter_len`,
    `PS`.`J_sw4_splinter_len` AS `ps_sw4_splinter_len`,
    (`PS`.`J_sw1_splinter_len` / `SW1`.`J_sw_phonetic_len`) AS `ps_sw1_splinter_len_to_sw_len`,
    (`PS`.`J_sw2_splinter_len` / `SW2`.`J_sw_phonetic_len`) AS `ps_sw2_splinter_len_to_sw_len`,
    (`PS`.`J_sw3_splinter_len` / `SW3`.`J_sw_phonetic_len`) AS `ps_sw3_splinter_len_to_sw_len`,
    (`PS`.`J_sw4_splinter_len` / `SW4`.`J_sw_phonetic_len`) AS `ps_sw4_splinter_len_to_sw_len`,
    (`PS`.`J_sw1_splinter_len` / `NU`.`J_nu_phonetic_len`) AS `ps_sw1_splinter_len_to_nu_len`,
    (`PS`.`J_sw2_splinter_len` / `NU`.`J_nu_phonetic_len`) AS `ps_sw2_splinter_len_to_nu_len`,
    (`PS`.`J_sw3_splinter_len` / `NU`.`J_nu_phonetic_len`) AS `ps_sw3_splinter_len_to_nu_len`,
    (`PS`.`J_sw4_splinter_len` / `NU`.`J_nu_phonetic_len`) AS `ps_sw4_splinter_len_to_nu_len`,
    `PM`.`type_of_splinter` AS `pm_name`,
    `PM`.`J_sw1_splinter` AS `pm_sw1_splinter`,
    `PM`.`J_sw2_splinter` AS `pm_sw2_splinter`,
    `PM`.`J_sw3_splinter` AS `pm_sw3_splinter`,
    `PM`.`J_sw4_splinter` AS `pm_sw4_splinter`,
    `PM`.`J_sw1_splinter_len` AS `pm_sw1_splinter_len`,
    `PM`.`J_sw2_splinter_len` AS `pm_sw2_splinter_len`,
    `PM`.`J_sw3_splinter_len` AS `pm_sw3_splinter_len`,
    `PM`.`J_sw4_splinter_len` AS `pm_sw4_splinter_len`,
    (`PM`.`J_sw1_splinter_len` / `SW1`.`J_sw_phonetic_len`) AS `pm_sw1_splinter_len_to_sw_len`,
    (`PM`.`J_sw2_splinter_len` / `SW2`.`J_sw_phonetic_len`) AS `pm_sw2_splinter_len_to_sw_len`,
    (`PM`.`J_sw3_splinter_len` / `SW3`.`J_sw_phonetic_len`) AS `pm_sw3_splinter_len_to_sw_len`,
    (`PM`.`J_sw4_splinter_len` / `SW4`.`J_sw_phonetic_len`) AS `pm_sw4_splinter_len_to_sw_len`,
    (`PM`.`J_sw1_splinter_len` / `NU`.`J_nu_phonetic_len`) AS `pm_sw1_splinter_len_to_nu_len`,
    (`PM`.`J_sw2_splinter_len` / `NU`.`J_nu_phonetic_len`) AS `pm_sw2_splinter_len_to_nu_len`,
    (`PM`.`J_sw3_splinter_len` / `NU`.`J_nu_phonetic_len`) AS `pm_sw3_splinter_len_to_nu_len`,
    (`PM`.`J_sw4_splinter_len` / `NU`.`J_nu_phonetic_len`) AS `pm_sw4_splinter_len_to_nu_len`,
    NU.J_lexsh_main  AS lexsh_main,
    NU.J_lexsh_sm    AS lexsh_sm,
    NU.J_lexsh_whatm AS lexsh_whatm,
    NU.J_split_point_1 AS split_point_1,
    NU.J_split_point_2 AS split_point_2,
    NU.J_split_point_3 AS split_point_3,
    NU.J_overlapping_letters AS overlapping_letters,
    NU.J_overlapping_phones AS overlapping_phones,
    NU.J_n_of_overlapping_letters AS n_of_overlapping_letters,
    NU.J_n_of_overlapping_phones AS n_of_overlapping_phones,
                      ...
                      (
                          (
                              (
                                  (
                                      (`naming_unit` `NU`)
                                      left join `image` `I` on(NU.image_id = I.image_id)
                                  )
