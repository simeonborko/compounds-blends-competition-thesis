    ...
    def _update_in_sheet(self, db_values: list, sheet_cells: List[Cell], indices: Iterable[int]) -> bool:
        ...
        for i in indices:
            ...
            if db_val != sh_val and (db_val or sh_val):
                # db_val je rozne od sh_val a zaroven su obe neprazdne (nie su None ani prazdny retazec)
...
class NamingUnitTable(Table):
    ...
    GS.G_sw2_splinter AS G_gs_sw2_splinter,
    GS.J_sw3_splinter AS J_gs_sw3_splinter,
    GS.G_sw3_splinter AS G_gs_sw3_splinter,
    GS.J_sw4_splinter AS J_gs_sw4_splinter,
    GS.G_sw4_splinter AS G_gs_sw4_splinter,
    
    GM.J_sw1_splinter AS J_gm_sw1_splinter,
    GM.G_sw1_splinter AS G_gm_sw1_splinter,
    GM.J_sw2_splinter AS J_gm_sw2_splinter,
    GM.G_sw2_splinter AS G_gm_sw2_splinter,
    GM.J_sw3_splinter AS J_gm_sw3_splinter,
    GM.G_sw3_splinter AS G_gm_sw3_splinter,
    GM.J_sw4_splinter AS J_gm_sw4_splinter,
    GM.G_sw4_splinter AS G_gm_sw4_splinter,
    
    PS.J_sw1_splinter AS J_ps_sw1_splinter,
    PS.G_sw1_splinter AS G_ps_sw1_splinter,
    PS.J_sw2_splinter AS J_ps_sw2_splinter,
    PS.G_sw2_splinter AS G_ps_sw2_splinter,
    PS.J_sw3_splinter AS J_ps_sw3_splinter,
    PS.G_sw3_splinter AS G_ps_sw3_splinter,
    PS.J_sw4_splinter AS J_ps_sw4_splinter,
    PS.G_sw4_splinter AS G_ps_sw4_splinter,
    
    PM.J_sw1_splinter AS J_pm_sw1_splinter,
    PM.G_sw1_splinter AS G_pm_sw1_splinter,
    PM.J_sw2_splinter AS J_pm_sw2_splinter,
    PM.G_sw2_splinter AS G_pm_sw2_splinter,
    PM.J_sw3_splinter AS J_pm_sw3_splinter,
    PM.G_sw3_splinter AS G_pm_sw3_splinter,
    PM.J_sw4_splinter AS J_pm_sw4_splinter,
    PM.G_sw4_splinter AS G_pm_sw4_splinter,
